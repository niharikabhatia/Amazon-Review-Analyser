...
export default function App() {
  ...
  const startAnalysis = async (products: string[]) => {
    ...
    try {
      // Step 1: Kick off Apify runs (returns immediately with run IDs)
      ...
      // Step 2: Poll /api/poll every 5s until all runs complete (max ~2.5 min)
      ...
      // Any runs still pending after timeout get an error entry
